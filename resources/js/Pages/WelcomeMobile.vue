    ...
    <LandingLayout title="Bienvenidos" class="overflow-x-hidden">
        <section>
            <figure class="w-[98%] mx-auto absolute top-4 left-1 -z-10">
                <img src="@/../../public/images/hero_mobile.webp" :draggable="false" class="w-full select-none"
        ...
        <section class="mt-[38vh] pt-10" id="history">
            ...
            <article v-if="currentSlide == 1" class="mt-5 relative">
                <figure
                    ...
                    <img src="@/../../public/images/history_content_mobile.webp" alt="Contenedor de historia"
                        class="select-none w-full" :draggable="false">
                </figure>
                <div class="mt-4 relative">
                    <div
                        class="bg-[#8B5E3C33] h-24 w-2/3 absolute top-8 left-0 intersect:motion-translate-x-in-[-90%] motion-translate-y-in-[0%] motion-duration-[2.00s]/translate">
                    </div>
                    <div
                        class="bg-[#8B5E3C] shadow-lg rounded-l-2xl h-44 w-1/2 absolute top-2 right-0 motion-translate-x-in-[90%] motion-translate-y-in-[0%] motion-duration-[4.00s]/translate">
                    </div>
                    <img src="@/../../public/images/slide1.webp" alt="Don Quirino sentado en una silla"
                        class="select-none w-[70%] absolute top-12 left-[13%] z-10 motion-preset-expand motion-duration-2000"
                        :draggable="false">
                    <div
                        class="bg-[#8B5E3C] shadow-lg rounded-r-2xl h-40 w-[40%] absolute top-48 left-0 motion-translate-x-in-[-90%] motion-translate-y-in-[0%] motion-duration-[4.00s]/translate">
                    </div>
                    <div
                        class="bg-[#8B5E3C33] h-24 rounded-l-2xl w-[20%] absolute top-60 right-0 motion-translate-x-in-[90%] motion-translate-y-in-[0%] motion-duration-[2.00s]/translate">
                    </div>
                </div>
            </article>
            <article v-if="currentSlide == 2" class="mt-5 relative">
                <figure
                    class="w-[96%] mx-auto relative motion-scale-in-[0.45] motion-translate-x-in-[-25%] motion-translate-y-in-[73%] motion-opacity-in-[0%] motion-rotate-in-[-15deg] motion-blur-in-[5px] motion-duration-[1.0s] motion-duration-[1.0s]/scale motion-duration-[1.0s]/translate motion-duration-[1.63s]/rotate">
                    <div class="absolute top-0 left-0 font-bold py-2 px-4 w-full">
                        <h2 class="text-center">Levantamiento en armas</h2>
                        <p class="mt-1 text-sm font-thin">
            ...
            <article v-if="currentSlide == 3" class="mt-5 relative">
                <figure
                    class="w-[96%] mx-auto relative motion-scale-in-[0.45] motion-translate-x-in-[-25%] motion-translate-y-in-[73%] motion-opacity-in-[0%] motion-rotate-in-[-15deg] motion-blur-in-[5px] motion-duration-[1.0s] motion-duration-[1.0s]/scale motion-duration-[1.0s]/translate motion-duration-[1.63s]/rotate">
                    <div class="absolute top-0 left-0 font-bold py-2 px-4 w-full">
                        <h2 class="text-center">La huida a caballo</h2>
                        <p class="mt-1 text-sm font-thin">
            ...
            <article v-if="currentSlide == 4" class="mt-5 relative">
                <figure
                    class="w-[96%] mx-auto relative motion-scale-in-[0.45] motion-translate-x-in-[-25%] motion-translate-y-in-[73%] motion-opacity-in-[0%] motion-rotate-in-[-15deg] motion-blur-in-[5px] motion-duration-[1.0s] motion-duration-[1.0s]/scale motion-duration-[1.0s]/translate motion-duration-[1.63s]/rotate">
                    <div class="absolute top-0 left-0 font-bold py-2 px-4 w-full">
                        <h2 class="text-center">Su legado y Tepatitlán</h2>
                        <p class="mt-2 text-sm font-thin">
